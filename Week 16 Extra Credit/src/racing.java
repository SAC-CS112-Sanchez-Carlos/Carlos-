...
public class racing {
	...
	public static void main(String[] args) throws Exception {
		...
		Automobile Truck = new Automobile(1999, "Toyota", "Tacoma", "Blue", "Trucky McTruckerson", 3);

		/* creates new instance of automobile called Van */
		Automobile Van = new Automobile(2001, "Toyota", "Sienna", "Burgendy", "Vann", 4);

		/* creates new instance of automobile called Sportcar */
		Automobile Sportcar = new Automobile(1996, "Toyota", "Celica", "Red", "Fancy Pants Sport Car", 6);
		...
		int choice = input.nextInt(); // assigns user input to variable
										// choice
